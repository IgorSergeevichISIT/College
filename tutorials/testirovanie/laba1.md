...
Для закрепления навыковсамостоятельно написать функцию для другой задачи (например, проверка числа на простоту) и составить для неё собственные тест-кейсы.
